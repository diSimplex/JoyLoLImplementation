...
int main(int argc, char* argv[]) {
  ...
  using interpreter_ptr = std::unique_ptr<joylolKernel::JoylolKernel>;
  interpreter_ptr interpreter = interpreter_ptr(new joylolKernel::JoylolKernel());
...
To compile the kernelMain we need: 

\startDescription{kernelMain.cpp}{gppCompile}
  \creates{cObj}{kernelMain.o}
